...
export function HeaderMain () {
    ...
    return (
        <header className="flex items-center h-24 bg-white-200">
            <Container>
                <div className="flex items-center gap-14 min-[350px]:max-w-[50%]">
                    <Logo />
                ...
                <div className="flex items-center gap-6">
                    <button className="flex items-center gap-4 h-16 bg-red-700 text-white px-5 py-2 rounded-xl hover:bg-yellow-500 duration-300 min-[350px]:text-sm min-[350px]:h-14">
                        {/*<UserCircle size={32}/>*/}
